...
| `arm2_lpv.launch.py` | 2-DoF arm | `lpv` | `arm2_lpv_controllers.yaml` | Gain scheduling: 9×9 = 81 LQR designs interpolated on the measured joint angles, regulating across the envelope from `(+1.0, −1.0)` to `(−0.9, +0.9)`. |
